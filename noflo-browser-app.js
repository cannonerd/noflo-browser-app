...
require.register("noflo-noflo-packets/graphs/First.fbp", function(exports, require, module){
module.exports = JSON.parse('{"processes":{"Range":{"component":"packets/Range"}},"connections":[{"data":"1","tgt":{"process":"Range","port":"length"}}],"exports":[{"private":"range.in","public":"in"},{"private":"range.out","public":"out"}]}');
});
require.register("noflo-noflo-packets/graphs/MergeConnections.fbp", function(exports, require, module){
module.exports = JSON.parse('{"processes":{"Merge":{"component":"Merge"},"Flatten":{"component":"packets/Flatten"}},"connections":[{"src":{"process":"Merge","port":"out"},"tgt":{"process":"Flatten","port":"in"}}],"exports":[{"private":"merge.in","public":"in"},{"private":"flatten.out","public":"out"}]}');
});
require.register("noflo-noflo-packets/component.json", function(exports, require, module){
module.exports = JSON.parse('{"name":"noflo-packets","description":"Packet Utilities for NoFlo","version":"0.1.4","author":"Kenneth Kan <kenhkan@gmail.com>","repo":"kenhkan/packets","keywords":[],"dependencies":{"noflo/noflo":"*","jashkenas/underscore":"*","noflo/noflo-core":"*"},"scripts":["components/CountPackets.js","components/Unzip.js","components/Defaults.js","components/DoNotDisconnect.js","components/DisconnectAfter.js","components/OnlyDisconnect.js","components/SplitPacket.js","components/Range.js","components/Flatten.js","components/Compact.js","components/Zip.js","components/SendWith.js","components/FilterPackets.js","components/FilterByValue.js","components/FilterByPosition.js","components/FilterPacket.js","components/UniquePacket.js","components/GroupByPacket.js","components/LastPacket.js","components/Counter.js","index.js","components/Replace.js","graphs/First.fbp","graphs/MergeConnections.fbp","components/Map.js"],"json":["component.json"],"noflo":{"icon":"dropbox","components":{"Compact":"components/Compact.js","CountPackets":"components/CountPackets.js","Counter":"components/Counter.js","Defaults":"components/Defaults.js","DisconnectAfter":"components/DisconnectAfter.js","DoNotDisconnect":"components/DoNotDisconnect.js","FilterByPosition":"components/FilterByPosition.js","FilterByValue":"components/FilterByValue.js","FilterPacket":"components/FilterPacket.js","FilterPackets":"components/FilterPackets.js","Flatten":"components/Flatten.js","GroupByPacket":"components/GroupByPacket.js","LastPacket":"components/LastPacket.js","Map":"components/Map.js","OnlyDisconnect":"components/OnlyDisconnect.js","Range":"components/Range.js","Replace":"components/Replace.js","SendWith":"components/SendWith.js","SplitPacket":"components/SplitPacket.js","UniquePacket":"components/UniquePacket.js","Unzip":"components/Unzip.js","Zip":"components/Zip.js"},"graphs":{"First":"graphs/First.fbp","MergeConnections":"graphs/MergeConnections.fbp"}},"fbp":["graphs/First.fbp","graphs/MergeConnections.fbp"]}');
});
  ...
  function Range() {
    ...
    this.inPorts.start.on("data", (function(_this) {
      return function(start) {
        return _this._start = parseInt(start);
      };
    })(this));
    ...
    this.inPorts["in"].on("data", (function(_this) {
      return function(data) {
        _this.totalCount++;
        if (_this.totalCount > _this._start && _this.totalCount < _this.end && _this.sentCount < _this.length) {
          _this.sentCount++;
          return _this.outPorts.out.send(data);
        }
      };
...
require.register("noflo-noflo-packets/components/Replace.js", function(exports, require, module){
var Replace, noflo,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
Replace = (function(_super) {
  ...
  Replace.prototype.description = 'Replace incoming packets with something else if they match certain packets';
  ...
  function Replace() {
    ...
    this.inPorts.match.on('data', (function(_this) {
      return function(match) {
        return _this.matches.push(match);
      };
    })(this));
    this.inPorts.replace.on('connect', (function(_this) {
      return function() {
        return _this.replacements = [];
      };
    })(this));
    this.inPorts.replace.on('data', (function(_this) {
      return function(replacement) {
        return _this.replacements.push(replacement);
      };
    })(this));
    this.inPorts["in"].on('begingroup', (function(_this) {
      return function(group) {
    ...
    this.inPorts["in"].on('data', (function(_this) {
      return function(data) {
        var index;
        index = _this.matches.indexOf(data);
        return _this.outPorts.out.send(index > -1 ? _this.replacements[index] : data);
      };
    })(this));
  }
...
require.register("noflo-noflo-packets/components/Map.js", function(exports, require, module){
var Map, noflo,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
Map = (function(_super) {
  ...
  Map.prototype.description = 'Replace packets through a map. Data that is not in the map is replace with the default.';
  ...
  function Map() {
    ...
    this.inPorts.data.on('data', (function(_this) {
      return function(data) {
        if (data in _this.map) {
          return _this.outPorts.data.send(_this.map[data]);
        } else {
          if (_this.def) {
            return _this.outPorts.data.send(_this.def);
          } else {
            return _this.outPorts.data.send(data);
          }
        }
      };
    })(this));
    this.inPorts.data.on('disconnect', (function(_this) {
      return function() {
        return _this.outPorts.data.disconnect();
      };
    })(this));
    this.inPorts.map.on('data', (function(_this) {
      return function(map) {
        var mapEntry, mapPart, mapParts, _i, _len, _ref, _results;
        if (typeof map === 'object') {
          _this.map = map;
          return;
        }
        _ref = mapParts = map.split(',');
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          mapPart = _ref[_i];
          mapEntry = mapPart.split(':');
          if (mapEntry[0] && mapEntry[1]) {
            _results.push(_this.map[mapEntry[0].trim()] = mapEntry[1].trim());
          } else {
            _results.push(void 0);
          }
        }
    ...
    this.inPorts.def.on('data', (function(_this) {
      return function(def) {
        return _this.def = def;
      };
    })(this));
  }
...
module.exports = JSON.parse('{"name":"c-base-workshop-test","description":"The best project ever.","author":"Jon Nordby <jononor@gmail.com>","repo":"noflo/noflo-browser-app","version":"0.1.0","keywords":[],"dependencies":{"noflo/noflo":"*","noflo/noflo-dom":"*","noflo/noflo-core":"*","noflo/noflo-interaction":"*","noflo/noflo-packets":"*","noflo/noflo-runtime-webrtc":"*"},"remotes":["https://raw.githubusercontent.com"],"scripts":["index.js","components/DoSomething.js","graphs/main.json","components/MultiplyByTwo.js","graphs/ListenClick.json"],"json":["graphs/main.json","component.json","graphs/ListenClick.json"],"noflo":{"graphs":{"ListenClick":"graphs/ListenClick.json","main":"graphs/main.json"},"components":{"DoSomething":"components/DoSomething.js","MultiplyByTwo":"components/MultiplyByTwo.js"}}}');
});
require.register("c-base-workshop-test/graphs/ListenClick.json", function(exports, require, module){
module.exports = JSON.parse('{"properties":{"name":"ListenClick","environment":{"type":"noflo-browser"}},"inports":{"selector":{"process":"dom/GetElement_rxuw1","port":"selector","metadata":{"x":36,"y":-144,"width":72,"height":72}}},"outports":{"getelement_error":{"process":"dom/GetElement_rxuw1","port":"error","metadata":{"x":0,"y":0,"width":72,"height":72}},"listenmouse_click":{"process":"interaction/ListenMouse_af0f9","port":"click","metadata":{"x":0,"y":0,"width":72,"height":72}}},"groups":[],"processes":{"dom/GetElement_rxuw1":{"component":"dom/GetElement","metadata":{"label":"dom/GetElement","x":180,"y":-108,"width":72,"height":72}},"interaction/ListenMouse_af0f9":{"component":"interaction/ListenMouse","metadata":{"label":"interaction/ListenMouse","x":360,"y":-144,"width":72,"height":72}}},"connections":[{"src":{"process":"dom/GetElement_rxuw1","port":"element"},"tgt":{"process":"interaction/ListenMouse_af0f9","port":"element"},"metadata":{}},{"data":"#button2","tgt":{"process":"dom/GetElement_rxuw1","port":"selector"}}]}');
});
...
require.register("c-base-workshop-test/components/MultiplyByTwo.js", function(exports, require, module){
var noflo;
...
module.exports = {
  ...
  "noflo": {
    ...
    "graphs": {
      "First": "graphs/First.fbp",
      "MergeConnections": "graphs/MergeConnections.fbp"
    }
  },
  "fbp": [
    "graphs/First.fbp",
...
require.alias("noflo-noflo/src/lib/Helpers.js", "noflo-noflo-packets/deps/noflo/src/lib/Helpers.js");
require.alias("noflo-noflo/src/lib/Streams.js", "noflo-noflo-packets/deps/noflo/src/lib/Streams.js");
...
require.alias("noflo-fbp/lib/fbp.js", "noflo-fbp/index.js");
require.alias("noflo-noflo/src/lib/NoFlo.js", "noflo-noflo/index.js");
require.alias("jashkenas-underscore/underscore.js", "noflo-noflo-packets/deps/underscore/underscore.js");
require.alias("jashkenas-underscore/underscore.js", "noflo-noflo-packets/deps/underscore/index.js");
require.alias("jashkenas-underscore/underscore.js", "jashkenas-underscore/index.js");
require.alias("noflo-noflo-core/components/Callback.js", "noflo-noflo-packets/deps/noflo-core/components/Callback.js");
require.alias("noflo-noflo-core/components/DisconnectAfterPacket.js", "noflo-noflo-packets/deps/noflo-core/components/DisconnectAfterPacket.js");
require.alias("noflo-noflo-core/components/Drop.js", "noflo-noflo-packets/deps/noflo-core/components/Drop.js");
require.alias("noflo-noflo-core/components/Group.js", "noflo-noflo-packets/deps/noflo-core/components/Group.js");
require.alias("noflo-noflo-core/components/Kick.js", "noflo-noflo-packets/deps/noflo-core/components/Kick.js");
require.alias("noflo-noflo-core/components/Merge.js", "noflo-noflo-packets/deps/noflo-core/components/Merge.js");
require.alias("noflo-noflo-core/components/Output.js", "noflo-noflo-packets/deps/noflo-core/components/Output.js");
require.alias("noflo-noflo-core/components/Repeat.js", "noflo-noflo-packets/deps/noflo-core/components/Repeat.js");
require.alias("noflo-noflo-core/components/RepeatAsync.js", "noflo-noflo-packets/deps/noflo-core/components/RepeatAsync.js");
require.alias("noflo-noflo-core/components/RepeatDelayed.js", "noflo-noflo-packets/deps/noflo-core/components/RepeatDelayed.js");
require.alias("noflo-noflo-core/components/SendNext.js", "noflo-noflo-packets/deps/noflo-core/components/SendNext.js");
require.alias("noflo-noflo-core/components/Split.js", "noflo-noflo-packets/deps/noflo-core/components/Split.js");
require.alias("noflo-noflo-core/components/RunInterval.js", "noflo-noflo-packets/deps/noflo-core/components/RunInterval.js");
require.alias("noflo-noflo-core/components/RunTimeout.js", "noflo-noflo-packets/deps/noflo-core/components/RunTimeout.js");
require.alias("noflo-noflo-core/components/MakeFunction.js", "noflo-noflo-packets/deps/noflo-core/components/MakeFunction.js");
require.alias("noflo-noflo-core/index.js", "noflo-noflo-packets/deps/noflo-core/index.js");
require.alias("noflo-noflo-core/components/ReadGlobal.js", "noflo-noflo-packets/deps/noflo-core/components/ReadGlobal.js");
require.alias("noflo-noflo/src/lib/Graph.js", "noflo-noflo-core/deps/noflo/src/lib/Graph.js");
require.alias("noflo-noflo/src/lib/InternalSocket.js", "noflo-noflo-core/deps/noflo/src/lib/InternalSocket.js");
require.alias("noflo-noflo/src/lib/BasePort.js", "noflo-noflo-core/deps/noflo/src/lib/BasePort.js");
require.alias("noflo-noflo/src/lib/InPort.js", "noflo-noflo-core/deps/noflo/src/lib/InPort.js");
